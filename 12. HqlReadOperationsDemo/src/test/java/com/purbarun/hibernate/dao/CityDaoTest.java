...
class CityDaoTest {
	...
	void findByIdTest() {
		...
		assertThat(actualCity).isEqualToComparingFieldByField(expectedCity).withFailMessage("Objects should be equal");
	}
	...
	void getAllTest() {
		...
		assertThat(actualList).contains(city1, city2).withFailMessage("list should have expected city objects");
	}
}
